...
<body class="bg-white min-h-screen flex items-center justify-center p-4 pattern-bg">
    <div class="w-full max-w-2xl">
        ...
        @error('role')
            <div class="mb-5 mt-2 flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 p-3 text-red-700 shadow-sm">

                <svg class="w-5 h-5 mt-0.5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <form id="registerForm" action="{{ route('register.post') }}" method="post" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="name" name="name" type="text" value="{{ old('name', $googleUser['name'] ?? '') }}"
                            required
                ...
                ">
                    ...
                    <div class="relative">
                        ...
                        <input id="email" name="email" type="email"
                            value="{{ old('email', $googleUser['email'] ?? '') }}" required
                            class="input-focus appearance-none block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg placeholder-gray-400 text-gray-900 focus:outline-none transition duration-150"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div id="passengerOption"
                            class="role-option border-2 border-gray-200 rounded-lg p-4 cursor-pointer text-center">
                ...
                <div class="flex items-center">
                    ...
                    <label for="terms" class="ml-2 block text-sm text-gray-700">
                        J'accepte les <a href="#" class="tripgo-yellow-text hover:underline">conditions
                            d'utilisation</a> et la <a href="#" class="tripgo-yellow-text hover:underline">politique de
                            confidentialité</a>
                    </label>
                </div>
